sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			...
			if (sHash) {
				sHash = "#ConditionalOperationsonTableScreenElements-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#ConditionalOperationsonTableScreenElements-display";
			}
